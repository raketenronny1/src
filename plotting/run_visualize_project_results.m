    ...
    try
        if exist('spider_plot_R2019b', 'file')
            spider_plot_R2019b(P_OR, ...
                ...
                'AxesFontColor', [0.2,0.2,0.2], 'AxesFontSize', plotFontSize_arg-1, ...
                'LabelFontSize', plotFontSize_arg, 'AxesLabelsOffset', axesLabelsOffset_val, ...
                'FillOption', 'off', ... % MAIN DATA FILL OFF
            ...
            spider_plot(P_OR, 'AxesLabels', spiderAxesLabels, 'AxesLimits', axesLimits, ...
                ...
                'FillOption', 'off', 'Color', strategyColors.OR, 'LineWidth', 2); % MAIN DATA FILL OFF
             warning('Using generic spider_plot.m for OR; std dev shading not directly supported in fallback.');
        end
    ...
    try
        if exist('spider_plot_R2019b', 'file')
            ...
            spider_plot(P_AND, 'AxesLabels', spiderAxesLabels, 'AxesLimits', axesLimits, ...
                'AxesInterval', axesInterval, 'AxesPrecision', 2, 'AxesDisplay', 'one', ...
                'AxesLabelsOffset', axesLabelsOffset_val, ... 
                'FillOption', 'off', 'Color', strategyColors.AND, 'LineWidth', 2); % MAIN DATA FILL OFF
            warning('Using generic spider_plot.m for AND; std dev shading not directly supported in fallback.');
        end
