...
function generate_exploratory_outlier_visualizations(input_X_spectra, ...
    ...
    fprintf('\n--- INSIDE generate_exploratory_outlier_visualizations ---\n');
...
end % end of generate_exploratory_outlier_visualizations
